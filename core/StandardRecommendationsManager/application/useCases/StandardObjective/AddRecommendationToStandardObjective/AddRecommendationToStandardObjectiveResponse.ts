...
export type AddRecommendationToStandardObjectiveResponse =
    Either<AppError.UnexpectedError | AddRecommendationToStandardObjectiveErrors.StandardObjectiveNotFoundError | AddRecommendationToStandardObjectiveErrors.StandardObjectiveRepoError | AddRecommendationToStandardObjectiveErrors.StandardObjectiveValidationError| AddRecommendationToStandardObjectiveErrors.NeedsRecommendationCreationFailed, Result<{ standardObjectiveId: AggregateID, recommendationId: AggregateID }>>