...
export type GetStandardObjectiveResponse = Either<
   AppError.UnexpectedError | GetStandardObjectiveErrors.ObjectiveNotFoundError,
   Result<StandardObjectiveDto | StandardObjectiveDto[]>
>;
