...
import {
   StandardObjectiveDto,
   StandardObjectiveError,
   StandardObjectiveMapper,
   StandardObjectivePersistenceType,
   StandardObjectiveRepository,
...
export class GetStandardObjectiveUseCase implements UseCase<GetStandardObjectiveRequest, GetStandardObjectiveResponse> {
   constructor(
      private repo: StandardObjectiveRepository,
      private mapper: Mapper<StandardObjective, StandardObjectivePersistenceType, StandardObjectiveDto>,
   ) {}
