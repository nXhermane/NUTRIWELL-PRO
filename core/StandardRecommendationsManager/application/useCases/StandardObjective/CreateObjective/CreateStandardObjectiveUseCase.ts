   ...
   async execute(request: CreateStandardObjectiveRequest): Promise<CreateStandardObjectiveResponse> {
      try {
         ...
         if (recommendationCombineResult.isFailure)
            return left(new CreateStandardObjectiveErrors.CreateStandardObjectiveFailed(recommendationCombineResult.err));
         ...
         if (standardObjectiveResult.isFailure)
            return left(new CreateStandardObjectiveErrors.CreateStandardObjectiveFailed(standardObjectiveResult.err));
