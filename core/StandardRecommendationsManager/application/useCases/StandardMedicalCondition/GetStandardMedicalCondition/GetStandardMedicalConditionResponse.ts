...
export type GetStandardMedicalConditionResponse = Either<AppError.UnexpectedError | GetStandardMedicalConditionErrors.MedicalConditionNotFoundError, Result<StandardMedicalConditionDto | StandardMedicalConditionDto[]>>