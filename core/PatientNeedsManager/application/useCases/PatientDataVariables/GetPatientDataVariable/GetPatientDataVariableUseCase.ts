...
import {
   PatientDataVariableDto,
   PatientDataVariablePersistence,
   PatientDataVariableRepository,
   PatientDataVariableRepositoryError,
} from "../../../../infrastructure";
...
export class GetPatientDataVariableUseCase implements UseCase<GetPatientDataVariableRequest, GetPatientDataVariableResponse> {
   constructor(
      private repo: PatientDataVariableRepository,
   ...
   async execute(request: GetPatientDataVariableRequest): Promise<GetPatientDataVariableResponse> {
      try {
         ...
         if (error instanceof PatientDataVariableRepositoryError)
            return left(new GetPatientDataVariableErrors.PatientDataVariableNotFoundError(error));
